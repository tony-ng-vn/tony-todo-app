...
- Finishing a task moves it to the recap.
  Work from earlier San Francisco days is archived into that day's recap automatically; Done always finishes the task.
